...
# ===== 실험 하이퍼 (그리드) =====
TAU_G_LIST = [0.1, 0.3, 0.9, 1, 3, 5, 7, 10]   # retain 쪽에서 good teacher와 KD할 온도
TAU_B_LIST = [0.1, 0.3, 0.9, 1, 3, 5, 7, 10]   # forget 쪽에서 bad teacher와 KD할 온도
EPOCH_COUNTS = list(range(1, 11))              # 언러닝 반복 에폭
